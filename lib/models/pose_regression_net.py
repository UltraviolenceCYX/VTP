...
from models.volumetric_transformer_pose import VTP
...
class PoseRegressionNet(nn.Module):
    ...
    def forward(self, all_heatmaps, meta, grid_centers):
        ...
        # valid_cubes = self.v2v_net(cubes[index].view(1,15,-1).transpose(1,2).contiguous())
